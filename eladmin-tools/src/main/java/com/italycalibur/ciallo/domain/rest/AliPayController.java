...
import com.italycalibur.ciallo.domain.vo.TradeVo;
import com.italycalibur.ciallo.domain.entity.AlipayConfig;
import com.italycalibur.ciallo.domain.enums.AliPayStatusEnum;
import com.italycalibur.ciallo.domain.utils.AlipayUtils;
import com.italycalibur.ciallo.domain.service.AliPayService;
...
public class AliPayController {
    ...
    @Operation(description = "支付之后跳转的链接")
    ...
    @AnonymousAccess
    @Operation(description = "支付异步通知(要公网访问)，接收异步通知，检查通知内容app_id、out_trade_no、total_amount是否与请求中的一致，根据trade_status进行后续业务处理")
