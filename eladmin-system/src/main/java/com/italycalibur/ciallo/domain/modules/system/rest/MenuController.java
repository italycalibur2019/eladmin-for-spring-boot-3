...
public class MenuController {
    ...
    @Operation(description = "获取前端所需菜单")
    ...
    @Operation(description = "根据菜单ID返回所有子节点ID，包含自身ID")
    ...
    @Operation(description = "查询菜单:根据ID获取同级与上级数据")
