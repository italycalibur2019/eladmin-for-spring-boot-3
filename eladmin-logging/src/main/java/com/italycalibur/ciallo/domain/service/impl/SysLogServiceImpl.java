...
import com.italycalibur.ciallo.domain.repository.LogRepository;
import com.italycalibur.ciallo.domain.service.SysLogService;
import com.italycalibur.ciallo.domain.service.dto.SysLogQueryCriteria;
import com.italycalibur.ciallo.domain.service.dto.SysLogSmallDto;
import com.italycalibur.ciallo.domain.service.mapstruct.LogErrorMapper;
import com.italycalibur.ciallo.domain.service.mapstruct.LogSmallMapper;
import com.italycalibur.ciallo.domain.utils.*;
...
public class SysLogServiceImpl implements SysLogService {
    ...
    private JSONObject getParameter(Method method, Object[] args) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (requestBody != null) {
                // [el-async-1] ERROR o.s.a.i.SimpleAsyncUncaughtExceptionHandler - Unexpected exception occurred invoking async method: public void com.italycalibur.ciallo.domain.service.impl.SysLogServiceImpl.save(java.lang.String,java.lang.String,java.lang.String,org.aspectj.lang.ProceedingJoinPoint,com.italycalibur.ciallo.domain.entity.SysLog)
